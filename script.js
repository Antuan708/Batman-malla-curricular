document.addEventListener('DOMContentLoaded', () => {
    ...
    const curriculum = {
        ...
        'Semestre 2': [
            ...
            { id: 'S2-07', name: 'Inglés A1-II', prerequisites: ['S1-06'] },
        ],
        'Semestre 3': [
            ...
            { id: 'S3-08', name: 'Inglés A1-III', prerequisites: ['S2-07'] },
        ...
        'Semestre 4': [
            ...
            { id: 'S4-08', name: 'Inglés A2-I', prerequisites: ['S3-08'] },
        ],
        'Semestre 5': [
            ...
            { id: 'S5-05', name: 'Inglés A2-II', prerequisites: ['S4-08'] },
        ],
        'Semestre 6': [
            ...
            { id: 'S6-08', name: 'Inglés A2-III', prerequisites: ['S5-05'] },
        ],
        'Semestre 7': [
